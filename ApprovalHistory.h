#ifndef APPROVALHISTORY_H
#define APPROVALHISTORY_H
...
public:
     ...
     */
    ApprovalHistory(HINSTANCE hInstane, const Users& user);
...
private:
    ...
    static void Close(ApprovalHistory& menu_instance);

    const char* className = "ApprovalHistoryClass"; ///< ウィンドウクラス名
};

#endif // APPROVALHISTORY_H